...
BLEStringCharacteristic stringMessage( "cce4a472-b106-11ec-b909-0242ac120002", BLERead | BLENotify, 20 );
...
GSRService.addCharacteristic(stringMessage);
  ...
  while (central.connected()) {
      ...
      if ( (millis() - lastDebounceTime) > debounceDelay) {
        ...
        if (buttonState == LOW) {
          ...
          buttonStatus.writeValue(buttionStatus);
          //stringMessage.writeValue("%c\" %c", GSR, GSR);
          Serial.println("%c\" %c", GSR, GSR);
